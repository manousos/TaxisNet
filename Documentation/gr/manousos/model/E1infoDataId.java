...
/**
 * E1infoDataId generated by hbm2java
 */
public class E1infoDataId implements java.io.Serializable {
    ...
    public E1infoDataId(int tid, int year) {
	this.tid = tid;
	this.year = year;
    }
	...
	if ((other == null))
	    return false;
	if (!(other instanceof E1infoDataId))
	    return false;
	E1infoDataId castOther = (E1infoDataId) other;
