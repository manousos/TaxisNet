...
public class Taxpayer  implements java.io.Serializable {
    ...
    public Taxpayer(Contact contact, User user, String afm, String fname, String lname, String fatherName) {
    ...
    public Taxpayer(Contact contact, User user, String afm, String fname, String lname, String fatherName, Set<E2> e2s, Set<Address> addresses, Set<E1> e1s) {
       this.contact = contact;
       this.user = user;
       this.afm = afm;
       this.fname = fname;
