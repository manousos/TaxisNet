...
public class E2estate  implements java.io.Serializable {
    ...
    public E2estate(E2 e2, String location, String position, String estateUsage, float area, String tenantFullName, String tenantAfm, int fromMonth, int toMonth, float monthlyRental, float rersentCoOwner, float revenueFreeHome, float revenueFreeOffice, float revenuePrivateHotel, float revenuePrivateOffice) {
        this.e2 = e2;
    ...
    public E2estate(E2 e2, String location, String position, String estateUsage, float area, String tenantFullName, String tenantAfm, int fromMonth, int toMonth, float monthlyRental, float rersentCoOwner, float revenueFreeHome, float revenueFreeOffice, float revenuePrivateHotel, float revenuePrivateOffice, Set<E2coOwner> e2coOwners) {
       this.e2 = e2;
       this.location = location;
       this.position = position;
       this.estateUsage = estateUsage;
