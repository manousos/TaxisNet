...
public class HibernateUtil {
	...
	static {
		...
		try {
			...
			log.error("Building SessionFactory failed." + ex.getMessage(), ex);
	 ...
	 */
	/*
	 * private static final SessionFactory sessionFactory; static { try {
	 * Configuration configuration = new Configuration().configure();
	 * sessionFactory = configuration.buildSessionFactory(); } catch (Throwable
